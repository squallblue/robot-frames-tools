...
const girdToggle = document.getElementById('grid-toggle');
...
girdToggle.addEventListener('click', () => {
    girdToggle.classList.toggle('checked');
    const checked = girdToggle.classList.contains('checked');
    if (checked) {
        viewer.showGrid()
    } else {
        viewer.hideGrid()
